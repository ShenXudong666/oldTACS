...
import os
#sys.path.append('./')
#sys.path.append("/TACS/tfqa")
#sys.path.append('./')
from transformers import AutoTokenizer
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
import tfqa.model.llama as llama
import torch
import random
...
if __name__ == '__main__':
    ...
    torch.save(svmlist, '/mnt/workspace/TACS/train/svm_sentence.pt')
    torch.save(svmlist, '/mnt/workspace/TACS/train/svm_sentence_acc.pt')
